...
local Functions = {
	...
	["setAbilityResource"] = { ow = "Set Ability Resource", args = { "player|array<player>", "button", "number" } },
	["setAimSpeed"] = { ow = "Set Aim Speed", args = { "player|array<player>", "number" } },
	["setAmmo"] = { ow = "Set Ammo", args = { "player|array<player>", "number", "number" } },
	["setCrouchEnabled"] = { ow = "Set Crouch Enabled", args = { "player|array<player>", "boolean" } },
	["setDamageDealt"] = { ow = "Set Damage Dealt", args = { "player|array<player>", "number" } },
	["setDamageReceived"] = { ow = "Set Damage Received", args = { "player|array<player>", "number" } },
	["setDeathEnvironmentCredit"] = { ow = "Set Environment Credit Player", args = { "player|array<player>", "player|array<player>" } },
	["setFacing"] = { ow = "Set Facing", args = { "player|array<player>", "vector", "relativity" } },
	["setHealingDealt"] = { ow = "Set Healing Dealt", args = { "player|array<player>", "number" } },
	["setHealingReceived"] = { ow = "Set Healing Received", args = { "player|array<player>", "number" } },
	["setInvisible"] = { ow = "Set Invisible", args = { "player|array<player>", "invis" } },
	["setJumpEnabled"] = { ow = "Set Jump Enabled", args = { "player|array<player>", "boolean" } },
	["setJumpVerticalSpeed"] = { ow = "Set Jump Vertical Speed", args = { "player|array<player>", "number" } },
	["setKnockbackDealt"] = { ow = "Set Knockback Dealt", args = { "player|array<player>", "number" } },
	["setKnockbackReceived"] = { ow = "Set Knockback Received", args = { "player|array<player>", "number" } },
	["setMaxAmmo"] = { ow = "Set Max Ammo", args = { "player|array<player>", "number", "number" } },
	["setMaxHealth"] = { ow = "Set Max Health", args = { "player|array<player>", "number" } },
	["setMeleeEnabled"] = { ow = "Set Melee Enabled", args = { "player|array<player>", "boolean" } },
	["setMoveSpeed"] = { ow = "Set Melee Enabled", args = { "player|array<player>", "number" } },
	["setAllowedHeroes"] = { ow = "Set Player Allowed Heroes", args = { "player|array<player>", "hero|array<hero>" } },
	["setHealth"] = { ow = "Set Player Health", args = { "player|array<player>", "number" } },
	["setScore"] = { ow = "Set Player Score", args = { "player|array<player>", "number" } },
	["setPrimaryFireEnabled"] = { ow = "Set Primary Fire Enabled", args = { "player|array<player>", "boolean" } },
	["setProjectileGravity"] = { ow = "Set Projectile Gravity", args = { "player|array<player>", "number" } },
	["setProjectileSpeed"] = { ow = "Set Projectile Speed", args = { "player|array<player>", "number" } },
	["setReloadEnabled"] = { ow = "Set Reload Enabled", args = { "player|array<player>", "boolean" } },
	["setRespawnMaxTime"] = { ow = "Set Respawn Max Time", args = { "player|array<player>", "number" } },
	["setSecondaryFireEnabled"] = { ow = "Set Secondary Fire Enabled", args = { "player|array<player>", "boolean" } },
	["setStatus"] = { ow = "Set Status", args = { "player|array<player>", "player", "status", "number" } },
	["setUltimateEnabled"] = { ow = "Set Ultimate Ability Enabled", args = { "player|array<player>", "boolean" } },
	["setUltimateCharge"] = { ow = "Set Ultimate Charge", args = { "player|array<player>", "number" } },
	["setWeapon"] = { ow = "Set Weapon", args = { "player|array<player>", "number" } },
	...
	["towards"] = { ow = "Vector Towards", args = { "vector", "vector" }, ret = "vector" },
